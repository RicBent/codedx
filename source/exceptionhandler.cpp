/*
    TODO:
        - Proper on console crash report (currently disabled)
...
const char* explaination_for_exception_type(u32 exceptionType)
{
...
void exception_handler(nn::os::UserExceptionInfo* exceptionInfo)
{
    ...
    LOG("Type: %s (0x%04X)\n\n", explaination_for_exception_type(exceptionInfo->type), exceptionInfo->type);
    ...
    nn::err::ApplicationErrorArg args(1,
        PROJECT_NAME " crashed!\n\nSee <Details> for exception information.",
        PROJECT_NAME " " PROJECT_VERSION_STRING " - Crash Report\n",
        languageCode);

    nn::err::ShowApplicationError(args);
    */
